...
public class TodosPerformanceTests {


    public static void main(String[] args) throws IOException, InterruptedException {
        // Create Todos
        FileWriter create_todo_time_file = new FileWriter("todos_csv/create_todo_time.csv");
        create_todo_time_file.append("Number Objects, Time (ms)\n");

        FileWriter create_todo_cpu_usage = new FileWriter("todos_csv/create_todo_cpu.csv");
        create_todo_cpu_usage.append("Number Objects ,CPU Usage\n");

        FileWriter create_todo_memory_usage = new FileWriter("todos_csv/create_todo_mem.csv");
        create_todo_memory_usage.append("Number Objects, Memory Usage (MB)\n");



        FileWriter edit_todo_time = new FileWriter("todos_csv/edit_todo_time.csv");
        edit_todo_time.append("Number Objects,Time (ms)\n");

        FileWriter edit_todo_cpu_usage = new FileWriter("todos_csv/edit_todo_cpu.csv");
        edit_todo_cpu_usage.append("Number Objects,CPU Usage\n");

        FileWriter edit_todo_memory_usage = new FileWriter("todos_csv/edit_todo_mem.csv");
        edit_todo_memory_usage.append("Number Objects,Memory Usage (MB)\n");



        FileWriter delete_todo_time = new FileWriter("todos_csv/delete_todo_time.csv");
        delete_todo_time.append("Number Objects, Time (ms)\n");

        FileWriter delete_todo_cpu_usage = new FileWriter("todos_csv/delete_todo_cpu.csv");
        delete_todo_cpu_usage.append("Number Objects, CPU Usage\n");

        FileWriter delete_todo_memory_usage = new FileWriter("todos_csv/delete_todo_mem.csv");
        ...
        TodosUnitTests todos = new TodosUnitTests();
